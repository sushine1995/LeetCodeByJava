...
/** 
* @author  suzw
* @version 创建时间：2018年4月26日 上午9:38:52 
* 类说明 
...
*/
public class _811_SubdomainVisitCount_子域名访问计数 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String[] string = {"9001 discuss.leetcode.com"};
		System.out.println(string[0]);
		System.out.println(subdomainVisits(string));
	}
